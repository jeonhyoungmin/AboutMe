...
class App {
  ...
  _setupCamera() {
    ...
    const camera = new THREE.PerspectiveCamera(5, width / height, 0.1, 20000);
  ...
  // 충돌 검사를 위한 코드, false = 캐릭터가 허공에 있음
  _bOnTheGround = false;
